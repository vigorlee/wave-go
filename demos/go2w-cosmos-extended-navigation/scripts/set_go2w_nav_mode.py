...
def profile(mode: str) -> dict[str, dict[str, Any]]:
    if mode == "avoid":
        ...
        height = (0.55, 1.40)
        controller = {
            "FollowPath.vx_max": number("SLOPE_NAV_VX_MAX", 0.48),
            "FollowPath.vx_min": number("SLOPE_NAV_VX_MIN", 0.10),
        ...
        optimizer = {
            "max_velocity": vector("SLOPE_NAV_MAX_VELOCITY", [0.48, 0.0, 0.55]),
            "min_velocity": vector("SLOPE_NAV_MIN_VELOCITY", [0.05, 0.0, -0.55]),
